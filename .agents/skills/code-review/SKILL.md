...
When Global Review finds a duplicate component, utility, or business abstraction, prefer reusing or consolidating an existing asset rather than creating another equivalent implementation.
